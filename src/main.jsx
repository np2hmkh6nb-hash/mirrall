...
function App() {
  ...
  return <>
    ...
    <main>
      <section id="top" className="hero"><video className="heroVideo" autoPlay muted loop playsInline preload="metadata" poster={`${rootPath}封面图.jpg`}><source src={`${rootPath}hero-loop.mp4`} type="video/mp4" /></video><div className="heroShade" /><div className="heroInner"><p className="eyebrow">AI DESIGNER / PRODUCT THINKER</p><h1>Zoe's<br /><span>数字幻境</span></h1><p className="heroCopy">我是 Zoe，一个还在不断试验的 AI 产品探索者。喜欢把新技术拆开、重组，再做成有趣、好用，也有一点想象力的体验。</p><a className="scrollCue" href="#project">向下探索 <b>↓</b></a></div><div className="heroStamp">Z / 2026<br />SCROLL TO ENTER</div></section>
